...
// calculate tiled rows and columns
	clip_width = (screen_width + 31)/16;
	clip_length = (screen_length + 31)/16;
...
void HookScriptThing(int &rpos)
{
	...
	int ev=V_atoi((const char*)rstring.mid(mark,rpos-mark));
	ExecuteEvent(ev);
}
